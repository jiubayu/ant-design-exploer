...
import { useMemo, useState, useEffect, useRef, useCallback, Fragment as Fragment$1 } from 'react';
...
var messageBoxShadow = css(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  box-shadow:\n    0 3px 6px -4px rgba(0, 0, 0, 0.12),\n    0 6px 16px 0 rgba(0, 0, 0, 0.08),\n    0 9px 28px 8px rgba(0, 0, 0, 0.05);\n"], ["\n  box-shadow:\n    0 3px 6px -4px rgba(0, 0, 0, 0.12),\n    0 6px 16px 0 rgba(0, 0, 0, 0.08),\n    0 9px 28px 8px rgba(0, 0, 0, 0.05);\n"])));
var templateObject_1$f;

var easing = {
    rubber: 'cubic-bezier(0.175, 0.885, 0.335, 1.05)',
};
var grow = keyframes(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  0%,100% {opacity: 1};\n  50% {opacity: .4}\n"], ["\n  0%,100% {opacity: 1};\n  50% {opacity: .4}\n"])));
var modalOpenAnimate = keyframes(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  0% {\n    opacity: 0;\n    transform: scaleY(0,0);\n  }\n  100% {\n     opacity: 1;\n     transform: scaleY(1, 1);\n      transform-origin:center;\n  }\n"], ["\n  0% {\n    opacity: 0;\n    transform: scaleY(0,0);\n  }\n  100% {\n     opacity: 1;\n     transform: scaleY(1, 1);\n      transform-origin:center;\n  }\n"])));
var modalCloseAnimate = keyframes(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n     transform:scale(1, 1);\n    transform-origin:center;\n  }\n  100% {\n     opacity: 0;\n    transform: scaleY(0,0);\n  }\n"], ["\n  0% {\n    opacity: 1;\n     transform:scale(1, 1);\n    transform-origin:center;\n  }\n  100% {\n     opacity: 0;\n    transform: scaleY(0,0);\n  }\n"])));
var messageOpenAnimate = keyframes(templateObject_4$9 || (templateObject_4$9 = __makeTemplateObject(["\n  0% {\n    opacity: 0;\n    margin-top: -30px;\n  }\n  50% {\n    opacity: 0.1;\n    margin-top: -15px;\n  }\n  100% {\n    opacity: 1;\n    margin-top: 0;\n  }\n"], ["\n  0% {\n    opacity: 0;\n    margin-top: -30px;\n  }\n  50% {\n    opacity: 0.1;\n    margin-top: -15px;\n  }\n  100% {\n    opacity: 1;\n    margin-top: 0;\n  }\n"])));
var messageCloseAnimate = keyframes(templateObject_5$9 || (templateObject_5$9 = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n    margin-top: 0;\n  }\n  100% {\n    opacity: 0;\n    margin-top: -30px;\n  }\n"], ["\n  0% {\n    opacity: 1;\n    margin-top: 0;\n  }\n  100% {\n    opacity: 0;\n    margin-top: -30px;\n  }\n"])));
var iconSpin = keyframes(templateObject_6$8 || (templateObject_6$8 = __makeTemplateObject(["\n  0% {\n     transform: rotate(0deg);\n  }\n  100% {\n     transform: rotate(360deg);\n  }\n"], ["\n  0% {\n     transform: rotate(0deg);\n  }\n  100% {\n     transform: rotate(360deg);\n  }\n"])));
var templateObject_1$e, templateObject_2$d, templateObject_3$b, templateObject_4$9, templateObject_5$9, templateObject_6$8;
...
/** style样式 */
var Text = styled.span(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  display: inline-block;\n  vertical-align: top;\n"], ["\n  display: inline-block;\n  vertical-align: top;\n"])));
var Loading = styled.span(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  position: absolute;\n  top: 50%;\n  left: 0;\n  right: 0;\n  opacity: 0;\n"], ["\n  position: absolute;\n  top: 50%;\n  left: 0;\n  right: 0;\n  opacity: 0;\n"])));
/** StyledButton */
var StyledButton = styled.button(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n  border: 0;\n  border-radius: 3em;\n  cursor: pointer;\n  display: inline-block;\n  overflow: hidden;\n  padding: ", ";\n  position: relative;\n  text-align: center;\n  text-decoration: none;\n  transition: all 150ms ease-out;\n  transform: translate3d(0, 0, 0);\n  vertical-align: top;\n  white-space: nowrap;\n  user-select: none;\n  opacity: 1;\n  margin: 0;\n  background: transparent;\n\n  font-size: ", "px;\n  font-weight: ", ";\n  line-height: 1;\n\n  ", "\n\n  ", " {\n    transform: scale3d(1, 1, 1) translate3d(0, 0, 0);\n    transition: transform 700ms ", ";\n    opacity: 1;\n  }\n\n  ", " {\n    transform: translate3d(0, 100%, 0);\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", ";\n\n  ", ";\n\n  ", ";\n\n  ", "\n\n  ", "\n\n      ", ";\n"], ["\n  border: 0;\n  border-radius: 3em;\n  cursor: pointer;\n  display: inline-block;\n  overflow: hidden;\n  padding: ", ";\n  position: relative;\n  text-align: center;\n  text-decoration: none;\n  transition: all 150ms ease-out;\n  transform: translate3d(0, 0, 0);\n  vertical-align: top;\n  white-space: nowrap;\n  user-select: none;\n  opacity: 1;\n  margin: 0;\n  background: transparent;\n\n  font-size: ", "px;\n  font-weight: ", ";\n  line-height: 1;\n\n  ", "\n\n  ", " {\n    transform: scale3d(1, 1, 1) translate3d(0, 0, 0);\n    transition: transform 700ms ", ";\n    opacity: 1;\n  }\n\n  ", " {\n    transform: translate3d(0, 100%, 0);\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", ";\n\n  ", ";\n\n  ", ";\n\n  ", "\n\n  ", "\n\n      ", ";\n"])), function (props) {
...
function Button(props) {
    ...
    var buttonInner = (jsxs(Fragment, { children: [jsx(Text, { children: children }), isLoading && jsx(Loading, { children: loadingText || 'Loading...' })] }));
    ...
    return (jsx(StyledButton, __assign({ as: btnType }, props, { "data-testid": 'button' }, { children: buttonInner })));
}
// 同时定义默认传参与导出
Button.defaultProps = {
    isLoading: false,
...
var templateObject_1$d, templateObject_2$c, templateObject_3$a;
...
var Svg = styled.svg(templateObject_4$8 || (templateObject_4$8 = __makeTemplateObject(["\n  display: ", ";\n  vertical-align: middle;\n\n  shape-rendering: inherit;\n  transform: translate3d(0, 0, 0);\n\n  ", "\n  ", "\n   ", "\n"], ["\n  display: ", ";\n  vertical-align: middle;\n\n  shape-rendering: inherit;\n  transform: translate3d(0, 0, 0);\n\n  ", "\n  ", "\n   ", "\n"])), function (props) { return (props.block ? 'block' : 'inline-block'); }, function (props) {
    return props.size === 'small' && css(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n      width: ", "px;\n      height: ", "px;\n    "], ["\n      width: ", "px;\n      height: ", "px;\n    "])), typography.size.s1, typography.size.s1);
}, function (props) {
    return props.size === 'middle' && css(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n      width: ", "px;\n      height: ", "px;\n    "], ["\n      width: ", "px;\n      height: ", "px;\n    "])), typography.size.s2, typography.size.s2);
}, function (props) {
    return props.size === 'large' && css(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n      width: ", "px;\n      height: ", "px;\n    "], ["\n      width: ", "px;\n      height: ", "px;\n    "])), typography.size.s2, typography.size.s2);
});
var Path = styled.path(templateObject_5$8 || (templateObject_5$8 = __makeTemplateObject(["\n  fill: ", ";\n"], ["\n  fill: ", ";\n"])), function (props) { return props.color; });
function Icon(props) {
    var icon = props.icon, color = props.color, block = props.block;
    return (jsx(Svg, __assign({ viewBox: '0 0 1024 1024', block: block, "data-testid": 'icon-path' }, props, { children: jsx(Path, { color: color, "data-testid": 'icon-svg', d: icons[icon] }) })));
}
Icon.defaultProps = {
    block: false,
    color: 'black',
...
var templateObject_1$c, templateObject_2$b, templateObject_3$9, templateObject_4$8, templateObject_5$8;
...
var Image$1 = styled.div(templateObject_6$7 || (templateObject_6$7 = __makeTemplateObject(["\n  background: ", ";\n  border-radius: 50%;\n  display: inline-block;\n  vertical-align: top;\n  overflow: hidden;\n  text-transform: uppercase;\n\n  height: ", "px;\n  width: ", "px;\n  line-height: ", "px;\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  img {\n    width: 100%;\n    height: auto;\n    display: block;\n  }\n\n  svg {\n    position: relative;\n    bottom: -2px;\n    height: 100%;\n    width: 100%;\n    vertical-align: top;\n  }\n\n  path {\n    fill: ", ";\n    animation: ", " 1.5s ease-in-out infinite;\n  }\n"], ["\n  background: ", ";\n  border-radius: 50%;\n  display: inline-block;\n  vertical-align: top;\n  overflow: hidden;\n  text-transform: uppercase;\n\n  height: ", "px;\n  width: ", "px;\n  line-height: ", "px;\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  img {\n    width: 100%;\n    height: auto;\n    display: block;\n  }\n\n  svg {\n    position: relative;\n    bottom: -2px;\n    height: 100%;\n    width: 100%;\n    vertical-align: top;\n  }\n\n  path {\n    fill: ", ";\n    animation: ", " 1.5s ease-in-out infinite;\n  }\n"])), function (props) { return (!props.isLoading ? 'transparent' : color.light); }, AvatarSizes.medium, AvatarSizes.medium, AvatarSizes.medium, function (props) {
    return props.size === 'tiny' && css(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "], ["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "])), AvatarSizes.tiny, AvatarSizes.tiny, AvatarSizes.tiny);
}, function (props) {
    return props.size === 'small' && css(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "], ["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "])), AvatarSizes.small, AvatarSizes.small, AvatarSizes.small);
}, function (props) {
    return props.size === 'medium' && css(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "], ["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "])), AvatarSizes.medium, AvatarSizes.medium, AvatarSizes.medium);
}, function (props) {
    return props.size === 'large' && css(templateObject_4$7 || (templateObject_4$7 = __makeTemplateObject(["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "], ["\n      height: ", "px;\n      width: ", "px;\n      line-height: ", "px;\n    "])), AvatarSizes.large, AvatarSizes.large, AvatarSizes.large);
}, function (props) {
    return !props.src && css(templateObject_5$7 || (templateObject_5$7 = __makeTemplateObject(["\n      background: ", ";\n    "], ["\n      background: ", ";\n    "])), !props.isLoading && '#37D5D3');
}, color.medium, grow);
var Initial = styled.div(templateObject_10$1 || (templateObject_10$1 = __makeTemplateObject(["\n  color: ", ";\n  text-align: center;\n\n  font-size: ", "px;\n  line-height: ", "px;\n\n  ", "\n\n  ", "\n\n  ", "\n"], ["\n  color: ", ";\n  text-align: center;\n\n  font-size: ", "px;\n  line-height: ", "px;\n\n  ", "\n\n  ", "\n\n  ", "\n"])), color.lightest, typography.size.s2, AvatarSizes.medium, function (props) {
    return props.size === 'tiny' && css(templateObject_7$5 || (templateObject_7$5 = __makeTemplateObject(["\n      font-size: ", "px;\n      line-height: ", "px;\n    "], ["\n      font-size: ", "px;\n      line-height: ", "px;\n    "])), parseFloat(typography.size.s1) - 2, AvatarSizes.tiny);
}, function (props) {
    return props.size === 'small' && css(templateObject_8$3 || (templateObject_8$3 = __makeTemplateObject(["\n      font-size: ", "px;\n      line-height: ", "px;\n    "], ["\n      font-size: ", "px;\n      line-height: ", "px;\n    "])), typography.size.s1, AvatarSizes.small);
}, function (props) {
    return props.size === 'large' && css(templateObject_9$2 || (templateObject_9$2 = __makeTemplateObject(["\n      font-size: ", "px;\n      line-height: ", "px;\n    "], ["\n      font-size: ", "px;\n      line-height: ", "px;\n    "])), typography.size.s3, AvatarSizes.large);
});
function Avatar(props) {
    var size = props.size, src = props.src, username = props.username, isLoading = props.isLoading;
    var avatarFigure = useMemo(function () {
        var avatarFigure = jsx(Icon, { icon: "useralt" });
        if (isLoading) ;
        else if (src) {
            avatarFigure = jsx("img", { src: src, alt: username });
        }
        else {
            avatarFigure = (jsx(Initial, __assign({ size: size, "aria-hidden": 'true' }, { children: username.substring(0, 1) })));
        }
        return avatarFigure;
    }, [isLoading, src, size, username]);
    return (jsx(Image$1, __assign({ size: size, isLoading: isLoading, src: src }, props, { children: avatarFigure })));
}
Avatar.defaultProps = {
    isLoading: false,
    username: 'loading',
...
var templateObject_1$b, templateObject_2$a, templateObject_3$8, templateObject_4$7, templateObject_5$7, templateObject_6$7, templateObject_7$5, templateObject_8$3, templateObject_9$2, templateObject_10$1;
...
var BedgeWrapper = styled.div(templateObject_6$6 || (templateObject_6$6 = __makeTemplateObject(["\n  display: inline-block;\n  vertical-align: top;\n  font-size: 11px;\n  line-height: 12px;\n  padding: 4px 12px;\n  border-radius: 3em;\n  font-weight: ", ";\n\n  svg {\n    height: 12px;\n    width: 12px;\n    margin-right: 4px;\n    margin-top: -2px;\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n"], ["\n  display: inline-block;\n  vertical-align: top;\n  font-size: 11px;\n  line-height: 12px;\n  padding: 4px 12px;\n  border-radius: 3em;\n  font-weight: ", ";\n\n  svg {\n    height: 12px;\n    width: 12px;\n    margin-right: 4px;\n    margin-top: -2px;\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n"])), typography.weight.bold, function (props) {
    return props.status === 'positive' && css(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n      color: ", ";\n      background: ", ";\n    "], ["\n      color: ", ";\n      background: ", ";\n    "])), badgeColor.positive, badgeBackground.positive);
}, function (props) {
    return props.status === 'negative' && css(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n      color: ", ";\n      background: ", ";\n    "], ["\n      color: ", ";\n      background: ", ";\n    "])), badgeColor.negative, badgeBackground.negative);
}, function (props) {
    return props.status === 'neutral' && css(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n      color: ", ";\n      background: ", ";\n    "], ["\n      color: ", ";\n      background: ", ";\n    "])), badgeColor.neutral, badgeBackground.neutral);
}, function (props) {
    return props.status === 'warning' && css(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n      color: ", ";\n      background: ", ";\n    "], ["\n      color: ", ";\n      background: ", ";\n    "])), badgeColor.warning, badgeBackground.warning);
}, function (props) {
    return props.status === 'error' && css(templateObject_5$6 || (templateObject_5$6 = __makeTemplateObject(["\n      color: ", ";\n      background: ", ";\n    "], ["\n      color: ", ";\n      background: ", ";\n    "])), badgeColor.error, badgeBackground.error);
});
function Badge(props) {
    return jsx(BedgeWrapper, __assign({}, props));
}
Badge.defaultProps = {
    status: 'neutral',
};
var templateObject_1$a, templateObject_2$9, templateObject_3$7, templateObject_4$6, templateObject_5$6, templateObject_6$6;

var Label = styled.label(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  position: relative;\n  height: 1em;\n  display: flex;\n  align-items: center;\n  cursor: ", ";\n  font-size: ", "px;\n  font-weight: ", ";\n"], ["\n  position: relative;\n  height: 1em;\n  display: flex;\n  align-items: center;\n  cursor: ", ";\n  font-size: ", "px;\n  font-weight: ", ";\n"])), function (props) { return (props.disabled ? 'not-allowed' : 'pointer'); }, typography.size.s2, typography.weight.bold);
var OptionalText = styled.span(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    return props.hideLabel && css(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n      border: 0px !important;\n      clip: rect(0 0 0 0) !important;\n      -webkit-clip-path: inset(100%) !important;\n      clip-path: inset(100%) !important;\n      height: 1px !important;\n      overflow: hidden !important;\n      padding: 0px !important;\n      position: absolute !important;\n      white-space: nowrap !important;\n      width: 1px !important;\n    "], ["\n      border: 0px !important;\n      clip: rect(0 0 0 0) !important;\n      -webkit-clip-path: inset(100%) !important;\n      clip-path: inset(100%) !important;\n      height: 1px !important;\n      overflow: hidden !important;\n      padding: 0px !important;\n      position: absolute !important;\n      white-space: nowrap !important;\n      width: 1px !important;\n    "])));
});
...
var RadioWrapper = styled.div(templateObject_5$5 || (templateObject_5$5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n"], ["\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n"])));
var Input = styled.input(templateObject_6$5 || (templateObject_6$5 = __makeTemplateObject(["\n  margin: 0 0.4em 0 0;\n  font-size: initial;\n  opacity: 0;\n\n  & + span {\n    &:before,\n    &:after {\n      position: absolute;\n      top: 0;\n      left: 0;\n      height: 1em;\n      width: 1em;\n      content: '';\n      display: block;\n      border-radius: 3em;\n    }\n  }\n\n  & + span:before {\n    box-shadow: ", " 0 0 0 1px inset;\n  }\n\n  &:focus + span:before {\n    box-shadow: ", " 0 0 0 1px inset;\n  }\n\n  &:checked + span:before {\n    box-shadow: ", " 0 0 0 1px inset;\n  }\n\n  &:checked:focus + span:before {\n    box-shadow:\n      ", " 0 0 0 1px inset;\n  }\n\n  & + span:after {\n    transition: all 150ms ease-out;\n    transform: scale3d(0, 0, 1);\n\n    height: 10px;\n    margin-left: 2px;\n    margin-top: 2px;\n    width: 10px;\n\n    opacity: 0;\n  }\n\n  &:checked + span:after {\n    transform: scale3d(1, 1, 1);\n    background: ", ";\n    opacity: 1;\n  }\n"], ["\n  margin: 0 0.4em 0 0;\n  font-size: initial;\n  opacity: 0;\n\n  & + span {\n    &:before,\n    &:after {\n      position: absolute;\n      top: 0;\n      left: 0;\n      height: 1em;\n      width: 1em;\n      content: '';\n      display: block;\n      border-radius: 3em;\n    }\n  }\n\n  & + span:before {\n    box-shadow: ", " 0 0 0 1px inset;\n  }\n\n  &:focus + span:before {\n    box-shadow: ", " 0 0 0 1px inset;\n  }\n\n  &:checked + span:before {\n    box-shadow: ", " 0 0 0 1px inset;\n  }\n\n  &:checked:focus + span:before {\n    box-shadow:\n      ", " 0 0 0 1px inset;\n  }\n\n  & + span:after {\n    transition: all 150ms ease-out;\n    transform: scale3d(0, 0, 1);\n\n    height: 10px;\n    margin-left: 2px;\n    margin-top: 2px;\n    width: 10px;\n\n    opacity: 0;\n  }\n\n  &:checked + span:after {\n    transform: scale3d(1, 1, 1);\n    background: ", ";\n    opacity: 1;\n  }\n"])), color.mediumdark, function (props) { return color[props.appearance]; }, function (props) { return color[props.appearance]; }, function (props) { return color[props.appearance]; }, function (props) { return color[props.appearance]; });
var Error$1 = styled.span(templateObject_7$4 || (templateObject_7$4 = __makeTemplateObject(["\n  font-weight: ", ";\n  font-size: ", "px;\n  color: ", ";\n  margin-left: 6px;\n  height: 1em;\n  display: flex;\n  align-items: center;\n"], ["\n  font-weight: ", ";\n  font-size: ", "px;\n  color: ", ";\n  margin-left: 6px;\n  height: 1em;\n  display: flex;\n  align-items: center;\n"])), typography.weight.regular, typography.size.s2, color.negative);
function Radio(props) {
    props.appearance; var label = props.label, hideLabel = props.hideLabel, error = props.error, description = props.description; props.wrapperClass; var disabled = props.disabled, restProps = __rest(props, ["appearance", "label", "hideLabel", "error", "description", "wrapperClass", "disabled"]);
    return (jsxs(RadioWrapper, { children: [jsxs(Label, __assign({ disabled: disabled }, { children: [jsx(Input, __assign({}, restProps, { role: "radio", "aria-invalid": !!error, type: "radio" })), jsx("span", { children: jsx(OptionalText, __assign({ hideLabel: hideLabel }, { children: label })) })] })), error && jsx(Error$1, { children: error }), description && jsx(Description, { children: description })] }));
}
Radio.defaultProps = {
    appearance: 'primary',
    hideLabel: false,
};
var templateObject_1$9, templateObject_2$8, templateObject_3$6, templateObject_4$5, templateObject_5$5, templateObject_6$5, templateObject_7$4;

var Transition = styled.div(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (props) {
...
var Wrapper = styled.div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  padding: 10px;\n  border-radius: 5px;\n  box-shadow: ", ";\n"], ["\n  padding: 10px;\n  border-radius: 5px;\n  box-shadow: ", ";\n"])), function (props) { return props.viewportBoxshadow; });
...
function Carousel(props) {
    ...
    return (jsxs(Wrapper, __assign({ ref: ref, viewportBoxshadow: '' }, { children: [jsx("div", __assign({ className: 'viewport', style: {
                    width: '100%',
                    height: "".concat(height, "px"),
                    overflow: 'hidden',
                    position: 'relative',
                } }, { children: jsx(Transition, __assign({ animation: animation.animation, direction: animation.direction, delay: autoplayDelay }, { children: jsx("div", __assign({ style: {
                            display: 'flex',
                            width: "".concat((bound === null || bound === void 0 ? void 0 : bound.width) * 3, "px"),
                            position: 'absolute',
                            left: "".concat(-(bound === null || bound === void 0 ? void 0 : bound.width), "px"),
                        } }, { children: state.map(function (v, i) { return (jsx("div", __assign({ style: {
                                width: "".concat(bound === null || bound === void 0 ? void 0 : bound.width, "px"),
                                height: "".concat(height, "px"),
                            } }, { children: v }), i)); }) })) })) })), jsx("ul", __assign({ style: {
                    display: 'flex',
                    justifyContent: 'center',
                    alignItems: 'center',
                } }, { children: new Array(totalLen).fill(1).map(function (x, y) {
                    return (jsx(Radio, { label: '', hideLabel: true, value: 0, appearance: radioAppear, checked: y === indexMap[1], onChange: function () { }, onClick: function () {
...
function useStateAnimation(parentSetState, delay) {
...
var CalendarWrapper = styled.div(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  position: absolute;\n  box-shadow: 0 0 2px 2px rgba(0,0,0,0.2);\n  transition: all ", "s\n    cubic-bezier(0.23, 1, 0.32, 1);\n  background: ", ";\n  ", "\n  ", "\n"], ["\n  position: absolute;\n  box-shadow: 0 0 2px 2px rgba(0,0,0,0.2);\n  transition: all ", "s\n    cubic-bezier(0.23, 1, 0.32, 1);\n  background: ", ";\n  ", "\n  ", "\n"])), function (props) { return props.delay / 1000; }, color.lightest, function (props) {
    return props.visible && css(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n      animation: ", " ", "s ease-in;\n    "], ["\n      animation: ", " ", "s ease-in;\n    "])), modalOpenAnimate, props.delay / 1000);
}, function (props) {
    return !props.visible && css(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n      animation: ", " ", "s ease-in;\n    "], ["\n      animation: ", " ", "s ease-in;\n    "])), modalCloseAnimate, props.delay / 1000);
});
var CalendarDateRow = styled.tr(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject([""], [""])));
var tableItemStyle = css(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  display: inline-block;\n  min-width: 24px;\n  height: 24px;\n  line-height: 24px;\n  border-radius: 2px;\n  margin: 2px;\n  text-align: center;\n"], ["\n  display: inline-block;\n  min-width: 24px;\n  height: 24px;\n  line-height: 24px;\n  border-radius: 2px;\n  margin: 2px;\n  text-align: center;\n"])));
var CalendarHeadItem = styled.td(templateObject_6$4 || (templateObject_6$4 = __makeTemplateObject(["\n  ", "\n  cursor: default;\n"], ["\n  ", "\n  cursor: default;\n"])), tableItemStyle);
var CalendarDate = styled.td(templateObject_7$3 || (templateObject_7$3 = __makeTemplateObject(["\n  ", "\n  cursor: pointer;\n  ", "\n  ", "\n"], ["\n  ", "\n  cursor: pointer;\n  ", "\n  ", "\n"])), tableItemStyle, function (props) {
    if (props.isonDay) {
...
var CalendarHeaderWrapper = styled.div(templateObject_8$2 || (templateObject_8$2 = __makeTemplateObject(["\n  padding: 10px;\n  display: flex;\n  color: ", ";\n  border-bottom: 1px solid #f0f0f0;\n  justify-content: center;\n"], ["\n  padding: 10px;\n  display: flex;\n  color: ", ";\n  border-bottom: 1px solid #f0f0f0;\n  justify-content: center;\n"])), rgba(0, 0, 0, 0.85));
var btnStyle$1 = {
    padding: '0px',
    background: color.lightest,
};
var IconWrapper$1 = styled.div(templateObject_9$1 || (templateObject_9$1 = __makeTemplateObject(["\n  display: inline-block;\n  vertical-align: middle;\n  & > svg {\n    height: 12px;\n  }\n"], ["\n  display: inline-block;\n  vertical-align: middle;\n  & > svg {\n    height: 12px;\n  }\n"])));
...
function DatePicker(props) {
    ...
    var modeDay = useMemo(function () { return (jsxs("table", __assign({ style: { display: mode === 'date' ? 'table' : 'none' } }, { children: [jsx("thead", { children: jsxs("tr", { children: [jsx(CalendarHeadItem, { children: "\u65E5" }), jsx(CalendarHeadItem, { children: "\u4E00" }), jsx(CalendarHeadItem, { children: "\u4E8C" }), jsx(CalendarHeadItem, { children: "\u4E09" }), jsx(CalendarHeadItem, { children: "\u56DB" }), jsx(CalendarHeadItem, { children: "\u4E94" }), jsx(CalendarHeadItem, { children: "\u516D" })] }) }), jsx("tbody", { children: dayData.map(function (d, index) { return (jsx(CalendarDateRow, { children: d.map(function (v, i) { return (jsx(CalendarDate, __assign({ isonDay: v.isonDay, isonMonth: v.isonMonth, onClick: function () {
                            var origin = v.origin;
                            var newCalDate = [
                                origin.getFullYear(),
                                origin.getMonth(),
                            ...
                            setst(false);
                        } }, { children: v.day }), i)); }) }, index)); }) })] }))); }, [dayData, setst, mode]);
    var modeMonth = useMemo(function () { return (jsx(MonthWrapper, __assign({ style: { display: mode === 'month' ? 'flex' : 'none' } }, { children: monthData.map(function (v, i) {
            return (jsxs(MonthItem, __assign({ onClick: function () {
                    // 获取当前月 计算和之前日期月的差值
    ...
    var modeYear = useMemo(function () {
        ...
        return (jsx(MonthWrapper, __assign({ style: { display: mode === 'year' ? 'flex' : 'none' } }, { children: yeamMap.map(function (v, i) { return (jsx(MonthItem, __assign({ toGray: i === 0 || i === 11, onClick: function () {
                    // 获取选择年份的差值
    ...
    var render = useMemo(function () {
        ...
        if (!show) {
            ...
            return (jsxs(CalendarWrapper, __assign({ style: style, className: classname, visible: st, delay: delay }, { children: [jsx(CalendarHeaderWrapper, { children: jsxs(BtnDiv, { children: [jsx(Button, __assign({ size: 'small', style: btnStyle$1, onClick: handleLeft }, { children: jsx(IconWrapper$1, { children: jsx(Icon, { icon: 'arrowleft' }) }) })), jsx(BtnDiv, { children: jsxs("span", { children: [jsx(BWrapper, __assign({ style: { display: mode === 'year' ? 'inline-block' : 'none' } }, { children: "".concat(startYear, "-").concat(startYear + 9) })), jsxs(BWrapper, __assign({ style: {
                                                    display: mode === 'month' || mode === 'date'
                                                        ? 'inline-block'
                                                        : 'none',
                                                }, onClick: function () { return setMode('year'); } }, { children: [calData[0], "\u5E74"] })), jsxs(BWrapper, __assign({ style: {
                                                    display: mode === 'date' ? 'inline-block' : 'none',
                                                }, onClick: function () { return setMode('month'); } }, { children: [calData[1] + 1, "\u6708"] }))] }) }), jsx(Button, __assign({ size: 'small', style: btnStyle$1, onClick: handleRight }, { children: jsx(IconWrapper$1, { children: jsx(Icon, { icon: 'arrowright' }) }) }))] }) }), jsxs("div", __assign({ style: { padding: '10px' } }, { children: [modeDay, modeMonth, modeYear] }))] })));
        }
    }, [show, unmount, st, calData, modeDay, modeMonth, modeYear, mode]);
    return (jsxs(DatePickerWrapper, __assign({ ref: ref }, { children: [jsx("input", { "aria-label": 'date picker', value: state, onChange: handleChange, onClick: handleClick, onBlur: handleBlur, style: { border: 'none', boxShadow: 'none', outline: 'none' } }), jsx(CalendarIcon, { children: jsx(Icon, { icon: 'calendar' }) }), render] })));
}
var templateObject_1$7, templateObject_2$6, templateObject_3$5, templateObject_4$4, templateObject_5$4, templateObject_6$4, templateObject_7$3, templateObject_8$2, templateObject_9$1, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14, templateObject_15, templateObject_16;

var MessageText = styled.span(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  display: inline-block;\n  padding: 10px 16px;\n  background: ", ";\n  color: ", ";\n  font-size: ", "px;\n  font-weight: ", ";\n  margin: 10px;\n  ", ";\n  border-radius: 2px;\n"], ["\n  display: inline-block;\n  padding: 10px 16px;\n  background: ", ";\n  color: ", ";\n  font-size: ", "px;\n  font-weight: ", ";\n  margin: 10px;\n  ", ";\n  border-radius: 2px;\n"])), function (props) { return props.bg; }, function (props) { return props.fc; }, typography.size.s2, typography.weight.bold, messageBoxShadow);
var IconWrapper = styled.span(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  margin-right: 10px;\n  & > svg {\n    font-size: ", "px;\n    ", "\n  }\n"], ["\n  margin-right: 10px;\n  & > svg {\n    font-size: ", "px;\n    ", "\n  }\n"])), typography.size.s2, function (props) {
    return props.spin && css(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n        animation: ", " 2s linear infinite;\n      "], ["\n        animation: ", " 2s linear infinite;\n      "])), iconSpin);
});
var MessageTextWrapper = styled.div(templateObject_6$3 || (templateObject_6$3 = __makeTemplateObject(["\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n"])), function (props) {
    return props.openState && css(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n      animation: ", " ", "s ease-in;\n    "], ["\n      animation: ", " ", "s ease-in;\n    "])), messageOpenAnimate, props.ani / 1000);
}, function (props) {
    return props.closeState && css(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n      animation: ", " ", "s ease-in;\n    "], ["\n      animation: ", " ", "s ease-in;\n    "])), messageCloseAnimate, props.ani / 1000);
});
var wrap;
function createMessage(type) {
    return function (content, config) {
        ...
        ReactDOM.render(jsx(Message, { rootDom: wrap, parentDom: divs, content: content, fconfig: fconfig, iconType: type }), divs);
    };
}
var defaultConfig = {
    mount: document.body,
...
function Message(props) {
    ...
    var renderIcon = useMemo(function () {
        switch (iconType) {
            case 'default':
                return null;
            case 'info':
                return (jsx(IconWrapper, { children: jsx(Icon, { icon: 'info', size: 'middle', color: color.primary }) }));
            case 'success':
                return (jsx(IconWrapper, { children: jsx(Icon, { icon: 'check', size: 'middle', color: color.positive }) }));
            case 'error':
                return (jsx(IconWrapper, { children: jsx(Icon, { icon: 'closeAlt', size: 'small', color: color.negative }) }));
            case 'warning':
                return (jsx(IconWrapper, { children: jsx(Icon, { icon: 'info', size: 'middle', color: color.warning }) }));
            case 'loading':
                return (jsx(IconWrapper, __assign({ spin: true }, { children: jsx(Icon, { icon: 'sync', size: 'middle' }) })));
            default:
                return null;
        }
    }, [iconType]);
    ...
    return (jsx(MessageTextWrapper, __assign({ openState: true, closeState: close, ani: fconfig.animationDuration }, { children: jsxs(MessageText, __assign({ bg: fconfig.background, fc: fconfig.color }, { children: [renderIcon, content] })) })));
}
var message = {
...
var templateObject_1$6, templateObject_2$5, templateObject_3$4, templateObject_4$3, templateObject_5$3, templateObject_6$3;
 ...
 * 3 confirm   可显示可不显示
 */
var ModalWrapper = styled.div(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  z-index: 1000;\n"], ["\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  z-index: 1000;\n"])));
var ModalViewPort = styled.div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  background: #fff;\n  border: none;\n  border-radius: 5px;\n  box-shadow: 2px 2px 4px #d9d9d9;\n  text-shadow:\n    1px 1px 4px #d9d9d9,\n    -1px -1px 4px #fff;\n  margin: 0 auto;\n  min-width: 320px;\n  overflow: hidden;\n  padding: 8px;\n  position: relative;\n  top: 100px;\n  transition: all 0.5s cubic-bezier(0.23, 1, 0.32, 1);\n  width: 30%;\n  z-index: 1001;\n  ", "\n\n  ", "\n"], ["\n  background: #fff;\n  border: none;\n  border-radius: 5px;\n  box-shadow: 2px 2px 4px #d9d9d9;\n  text-shadow:\n    1px 1px 4px #d9d9d9,\n    -1px -1px 4px #fff;\n  margin: 0 auto;\n  min-width: 320px;\n  overflow: hidden;\n  padding: 8px;\n  position: relative;\n  top: 100px;\n  transition: all 0.5s cubic-bezier(0.23, 1, 0.32, 1);\n  width: 30%;\n  z-index: 1001;\n  ", "\n\n  ", "\n"])), function (props) {
    return props.visible && css(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n      animation: ", " ", "s ease-in;\n    "], ["\n      animation: ", " ", "s ease-in;\n    "])), modalOpenAnimate, props.delay / 1000);
}, function (props) {
    return !props.visible && css(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n      animation: ", " ", "s ease-in;\n    "], ["\n      animation: ", " ", "s ease-in;\n    "])), modalCloseAnimate, props.delay / 1000);
});
var ModalMask = styled.div(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  background-color: rgba(0, 0, 0, 0.45);\n  bottom: 0;\n  left: 0;\n  position: fixed;\n  right: 0;\n  top: 0;\n"], ["\n  background-color: rgba(0, 0, 0, 0.45);\n  bottom: 0;\n  left: 0;\n  position: fixed;\n  right: 0;\n  top: 0;\n"])));
var CloseBtn = styled.div(templateObject_6$2 || (templateObject_6$2 = __makeTemplateObject(["\n  position: absolute;\n  right: 5px;\n  top: 5px;\n"], ["\n  position: absolute;\n  right: 5px;\n  top: 5px;\n"])));
var ConfirmWrapper = styled.div(templateObject_7$2 || (templateObject_7$2 = __makeTemplateObject(["\n  display: flex;\n  justify-content: flex-end;\n  align-item: center;\n  padding: 10px;\n"], ["\n  display: flex;\n  justify-content: flex-end;\n  align-item: center;\n  padding: 10px;\n"])));
var ChildrenWrapper = styled.div(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n  min-height: 100px;\n  padding: 10px;\n"], ["\n  min-height: 100px;\n  padding: 10px;\n"])));
...
function useAnimation(parentSetState, delay) {
    var _a = useState(true), state = _a[0], setState = _a[1];
    var _b = useMemo(function () {
        var timer;
        var innerclose = function (v) {
...
function Modal(props) {
    var visible = props.visible, maskClose = props.maskClose, closeButton = props.closeButton, delay = props.delay, mask = props.mask, _a = props.container, container = _a === void 0 ? document.body : _a, confirm = props.confirm, okText = props.okText; props.style; var cancelText = props.cancelText, onOk = props.onOk, onCancel = props.onCancel, callback = props.callback, title = props.title, parentSetState = props.parentSetState, stopScroll = props.stopScroll, portralstyle = props.portralstyle, refCallback = props.refCallback, closeCallback = props.closeCallback;
    var ref = useRef(null);
    var _b = useAnimation(parentSetState, delay), setState = _b[1], unmount = _b[2];
    var render = useMemo(function () {
        if (!visible) {
            unmount();
            return null;
            ...
            return createPortal(jsxs(ModalWrapper, __assign({ ref: ref, style: portralstyle }, { children: [jsxs(ModalViewPort, __assign({ visible: visible, delay: delay }, { children: [jsxs("div", { children: [title && jsx(TitleWrapper, { children: title }), closeButton && (jsx(CloseBtn, { children: jsx(Button, __assign({ style: {
                                                background: 'white',
                                                borderRadius: '5px',
                                                padding: '5px',
                                            }, onClick: function () {
                                                ...
                                                if (closeCallback)
                                                    closeCallback();
                                            } }, { children: jsx(Icon, { icon: 'closeAlt' }) })) }))] }), jsx(ChildrenWrapper, { children: props.children }), confirm && (jsxs(ConfirmWrapper, { children: [jsx(Button, __assign({ appearance: 'secondary', onClick: function () {
                                            onOk ? onOk(setState) : setState(false);
                                            if (callback)
                                                callback(true);
                                        } }, { children: okText ? okText : '确认' })), jsx(Button, __assign({ appearance: 'secondary', onClick: function () {
                                            onCancel ? onCancel(setState) : setState(false);
                                            if (callback)
                                                callback(false);
                                        }, style: { marginLeft: '10px' } }, { children: cancelText ? cancelText : '取消' }))] }))] })), mask && (jsx(ModalMask, { onClick: function () {
                            if (maskClose) {
                                setState(false);
                                if (closeCallback) {
                                    closeCallback();
...
var templateObject_1$5, templateObject_2$4, templateObject_3$3, templateObject_4$2, templateObject_5$2, templateObject_6$2, templateObject_7$2, templateObject_8$1, templateObject_9;

var PageUl = styled.ul(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  & > li {\n    list-style: none;\n  }\n  & button {\n    border-radius: 6px;\n    padding: 10px 8px;\n  }\n  & span {\n    line-height: 13.6px;\n    height: 13.6px;\n    min-width: 18px;\n  }\n  & svg {\n    height: 13.6px;\n    width: 13.6px;\n    vertical-align: bottom;\n  }\n"], ["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  & > li {\n    list-style: none;\n  }\n  & button {\n    border-radius: 6px;\n    padding: 10px 8px;\n  }\n  & span {\n    line-height: 13.6px;\n    height: 13.6px;\n    min-width: 18px;\n  }\n  & svg {\n    height: 13.6px;\n    width: 13.6px;\n    vertical-align: bottom;\n  }\n"])));
...
function Pagination(props) {
    ...
    return (jsxs(PageUl, __assign({ style: style, className: classnames }, { children: [jsx("li", { children: jsx(Button, __assign({ disabled: current === 1, appearance: 'primaryOutline', onClick: function () {
                        if (state.length > 0) {
                            if (state[0] > 1) {
                    ...
                    } }, { children: jsx(Icon, { icon: 'arrowleft' }) })) }), state.map(function (v, i) {
                return (jsx("li", { children: jsx(Button, __assign({ onClick: function () {
                            setCurrent(v);
                            var arr = calculateMove(v, state, totalPage);
                            if (arr)
                                setState(arr);
                        }, appearance: current === v ? 'primary' : 'primaryOutline' }, { children: v })) }, i));
            }), jsx("li", { children: jsx(Button, __assign({ disabled: current === totalPage, appearance: 'primaryOutline', onClick: function () {
                        if (state.length > 0) {
                    ...
                    } }, { children: jsx(Icon, { icon: 'arrowright' }) })) })] })));
}
...
function Progress(props) {
    ...
    var render = useMemo(function () {
        if (circle) {
            return (jsxs(CircleWrapper, __assign({ style: style, className: className }, { children: [jsxs("svg", __assign({ width: size, height: size, viewBox: '0 0 420 420', style: { transform: 'rotate(270deg)' } }, { children: [jsx("defs", { children: jsxs("radialGradient", __assign({ id: 'linear', r: '100%', cx: '100%', cy: '100%', spreadMethod: 'pad' }, { children: [jsx("stop", { offset: '0%', stopColor: '#40a9ff' }), jsx("stop", { offset: '100%', stopColor: '#36cfc9' })] })) }), jsx("circle", { cx: '210', cy: '210', r: '170', strokeWidth: '40', stroke: '#f5f5f5', fill: 'none' }), jsx("circle", { cx: '210', cy: '210', r: '170', strokeWidth: '40', stroke: 'url(#linear)', fill: 'none', opacity: state === 0 ? 0 : 1, strokeLinecap: 'round', strokeDasharray: dasharray, strokeDashoffset: '0px', style: {
                        ...
                        } }, { children: jsx(CircleText, __assign({ size: size }, { children: progressText ? progressText : "".concat(state, "%") })) }))] })));
        }
        else {
            return (jsxs(BarWrapper, __assign({ style: style, className: className }, { children: [jsx(BarMainWrapper, __assign({ bottomColor: bottomColor, height: height }, { children: jsx(BarMain, { flashColor: flashColor, primary: primary, secondary: secondary, state: state, height: height }) })), countNumber && (jsx(BarText, __assign({ height: height }, { children: progressText ? progressText : "".concat(state, "%") })))] })));
        }
    }, [
        circle,
        state,
...
var TableHeaderSpan = styled.span(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  display: inline-block;\n  position: absolute;\n  right: 0;\n  top: 0;\n  padding: 16px;\n  cursor: pointer;\n  & > svg {\n    width: 10px;\n    height: 10px;\n  }\n"], ["\n  display: inline-block;\n  position: absolute;\n  right: 0;\n  top: 0;\n  padding: 16px;\n  cursor: pointer;\n  & > svg {\n    width: 10px;\n    height: 10px;\n  }\n"])));
var mapData = function (data, columnData) {
    return data.map(function (v) {
        return (jsx("tr", { children: columnData.map(function (cm, i) {
                return (jsx("td", { children: jsx("span", { children: cm.render
...
function Table(props) {
    ...
    return (jsx("div", { children: jsxs(StyledTable, { children: [jsx("thead", { children: jsx("tr", { children: columnData.map(function (v, i) {
                            return (jsxs("th", { children: [jsx("span", { children: v.title }), v.sorter && sorted && v.sorter.compare && (jsxs(TableHeaderSpan, __assign({ onClick: function () {
                                            if (filterState[i]) {
                                                // 如果已经开启了排序
                                                // 1 进行逆序 否则 清空
                                                if (filterState[i] === 1) {
                                        ...
                                        } }, { children: [jsx(Icon, { icon: 'arrowup', block: true, color: filterState[i] === 1 ? color.primary : color.dark }), jsx(Icon, { icon: 'arrowdown', block: true, color: filterState[i] === 2 ? color.primary : color.dark })] })))] }, v.dataIndex));
                        }) }) }), jsx("tbody", { children: renderData }), pagination && (jsx(Pagination, { style: { justifyContent: 'flex-end' }, total: totalLen, pageSize: pageSize, callback: function (v) { return setCurrent(v - 1); }, defaultCurrent: 1 }))] }) }));
}
Table.defaultProps = {
    sorted: true,
    pagination: false,
...
var TreeItem = styled.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  padding-left: ", "px;\n  padding-top: 2px;\n  padding-bottom: 2px;\n  display: flex;\n  align-items: center;\n  position: relative;\n  overflow: hidden;\n  ", "\n"], ["\n  padding-left: ", "px;\n  padding-top: 2px;\n  padding-bottom: 2px;\n  display: flex;\n  align-items: center;\n  position: relative;\n  overflow: hidden;\n  ", "\n"])), function (props) { return originPadding * props.level; }, function (props) {
...
var TreeIcon = styled.span(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  & > svg {\n    transition: linear 0.2s;\n    height: 10px;\n    margin-bottom: 5px;\n    ", "\n  }\n"], ["\n  & > svg {\n    transition: linear 0.2s;\n    height: 10px;\n    margin-bottom: 5px;\n    ", "\n  }\n"])), function (props) {
...
var TreeGap = styled.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  position: absolute;\n  width: 100%;\n  height: 90%;\n  background-color: ", "\n  ", ";\n  ", "\n"], ["\n  position: absolute;\n  width: 100%;\n  height: 90%;\n  background-color: ", "\n  ", ";\n  ", "\n"])), function (props) { return props.backColor; }, function (props) {
    switch (props.x) {
        case 1:
...
function Tree(props) {
    ...
    return (jsx("div", __assign({ ref: ref, style: style, className: classname }, { children: data
            .filter(function (v) { return v.visible === true; })
            .map(function (g) {
            return (jsxs(TreeItem, __assign({ draggable: drag, highlight: highlight, itemkey: g.key, onClick: function () {
                    return changeVisible(g, function () { return forceUpdate(function (state) { return state + 1; }); });
                }, level: g.level, borderColor: borderColor, style: {
                ...
                } }, { children: [jsx(TreeIcon, __assign({ g: g }, { children: jsx(Icon, { icon: 'arrowdown' }) })), jsx("span", { children: g.value }), doverState.drag && (jsx(TreeGap, { gKey: g.key, drag: doverState.drag, x: doverState.x, itemkey: doverState.itemkey, backColor: backColor }))] }), g.key));
        }) })));
}
Tree.defaultProps = {
    source: [],
...
var updateFilist = function (setFlist, _file, uploadPartial) {
...
function UploadList(props) {
    ...
    return (jsx("ul", { children: flist.map(function (f) {
            return (jsx(ProgressLi, { children: jsxs(ProgressListItem, { children: [jsx(ProgressBarListItemName, __assign({ status: f.status }, { children: f.filename })), jsx("div", { children: jsx(Button, __assign({ style: { padding: 0, background: 'transparent' }, onClick: function () { return onRemove(f); } }, { children: jsx(Icon, { icon: 'close', color: chooseProgressListColor(f.status) }) })) }), (f.status === 'upload' ||
                            f.status === 'ready') && (jsx(Progress, { count: f.percent }))] }) }, f.uid));
        }) }));
}
var IconSpin = styled.span(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  & > svg {\n    ", "\n  }\n"], ["\n  & > svg {\n    ", "\n  }\n"])), css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      animation: ", " 2s linear infinite;\n    "], ["\n      animation: ", " 2s linear infinite;\n    "])), iconSpin));
function ImageList(props) {
    ...
    return (jsx(Fragment$1, { children: flist.map(function (f) {
            return (jsx("span", { children: jsxs(ImgWraper, { children: [f.status === 'success' && (jsx("img", { src: f.img, alt: 'upload img' })), (f.status === 'upload' || f.status === 'ready') && (jsx(IconSpin, { children: jsx(Icon, { icon: 'sync', color: color.warning }) })), f.status === 'failed' && (jsx(IconSpin, { children: jsx(Icon, { icon: 'photo', color: color.negative }) })), jsx(ImageCloseButton, __assign({ className: 'closebtn', onClick: function () { return onRemove(f); } }, { children: jsx(Icon, { icon: 'trash', color: color.light }) }))] }) }, f.uid));
        }) }));
}
var btnStyle = {
    padding: '10px',
...
function Upload(props) {
    ...
    return (jsxs("div", { children: [jsx("input", { ref: inputRef, type: 'file', onChange: handleChange, style: { display: 'none' }, value: '', accept: accept, multiple: multiple }), uploadMode === 'default' && (jsxs(Fragment, { children: [shouldShow && (jsx(Button, __assign({ onClick: handleClick, isLoading: resolveBtnLoading(flist), loadingText: '\u4E0A\u4F20\u4E2D...' }, { children: "upload" }))), jsx(UploadList, { flist: flist, onRemove: onRemove })] })), uploadMode === 'img' && (jsxs(Fragment, { children: [shouldShow && (jsx(ImgUpload, __assign({ onClick: handleClick }, { children: jsx(Icon, { icon: 'plus' }) }))), jsx(ImageList, { flist: flist, onRemove: onRemove, setFlist: setFlist })] })), jsxs(Modal, __assign({ title: '\u56FE\u7247\u88C1\u526A', callback: function (v) {
                    var _a;
                    if (v) {
                ...
                }, maskClose: true, closeButton: false, confirm: true, visible: modalOpen, parentSetState: setModalOpen }, { children: [jsx("div", __assign({ onMouseDown: handleMouseDown, onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, onMouseLeave: handleMouseLeave }, { children: jsx("canvas", __assign({ width: 300, height: 300, style: {
                                width: '100%',
                                height: '100%',
                                border: '1px dashed #ff4785',
                            }, ref: canvasRef }, { children: "\u60A8\u7684\u6D4F\u89C8\u5668\u4E0D\u652F\u6301canvas" })) })), jsxs("div", { children: [jsx(Button, __assign({ appearance: 'primary', style: btnStyle, onClick: function () {
                                    var newContent = __assign(__assign({}, modalContent), { times: modalContent.times + 0.1 });
                                    setModalContent(newContent);
                                    canvasDraw(newContent, canvasRef.current);
                                } }, { children: jsx(Icon, { icon: 'zoom', color: color.light }) })), jsx(Button, __assign({ appearance: 'primary', style: btnStyle, onClick: function () {
                                    var newContent = __assign(__assign({}, modalContent), { times: modalContent.times - 0.1 });
                                    setModalContent(newContent);
                                    canvasDraw(newContent, canvasRef.current);
                                } }, { children: jsx(Icon, { icon: 'zoomout', color: color.light }) })), jsx(Button, __assign({ appearance: 'primary', style: btnStyle, onClick: function () {
                                    var newContent = __assign(__assign({}, modalContent), { rotate: modalContent.rotate - 0.1 });
                                    setModalContent(newContent);
                                    canvasDraw(newContent, canvasRef.current);
                                } }, { children: jsx(Icon, { icon: 'undo', color: color.light }) })), jsx(Button, __assign({ appearance: 'primary', style: rotateBtnStyle, onClick: function () {
                                    var newContent = __assign(__assign({}, modalContent), { rotate: modalContent.rotate + 0.1 });
                                    setModalContent(newContent);
                                    canvasDraw(newContent, canvasRef.current);
                                } }, { children: jsx(Icon, { icon: 'undo', color: color.light }) })), jsx(Button, __assign({ appearance: 'primary', style: btnStyle, onClick: function () {
                                    var newContent = __assign(__assign({}, modalContent), { rotate: 0, times: 1, left: 0, right: 0 });
                                    setModalContent(newContent);
                                    canvasDraw(newContent, canvasRef.current);
                                } }, { children: jsx(Icon, { icon: 'zoomreset', color: color.light }) }))] })] }))] }));
}
Upload.defaultProps = {
    axiosConfig: {},
...
export { Avatar, Badge, Button, Carousel, DatePicker as DataPicker, Icon, Message, Modal, Pagination, Progress, Radio, Table, Tree, Upload };
